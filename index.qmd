---
title: "Computational Probability - Fall 2025"
execute: 
  freeze: false
---
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1ZfnybnUxzkyDCx4gGUjQVPXUyHnu3VlqWipHDMe17VU/edit?usp=sharing")
```
